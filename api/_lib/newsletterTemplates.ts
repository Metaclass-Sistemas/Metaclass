...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #020617;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(90deg, #020617 0%, #0f172a 55%, #0c1a2e 100%); padding: 40px 20px;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #0f172a; border-radius: 10px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.35); border: 1px solid rgba(148,163,184,0.18);">
          <tr>
          ...
          <tr>
            <td style="padding: 34px 28px 10px;">
              ...
              <h2 style="margin: 14px 0 10px; color: #ffffff; font-size: 24px; line-height: 1.25;">Inscrição confirmada</h2>
              ...
              <p style="margin: 14px 0 0; color: rgba(255,255,255,0.60); font-size: 14px; line-height: 1.7;">
          ...
          <tr>
            <td style="padding: 0 28px 26px;">
              <div style="border: 1px solid rgba(148,163,184,0.22); border-radius: 10px; padding: 14px 14px; background: rgba(148,163,184,0.08);">
                <div style="color: rgba(255,255,255,0.60); font-size: 13px; line-height: 18px;">E-mail inscrito</div>
                <div style="margin-top: 6px; color: #ffffff; font-size: 14px; font-weight: 800;">${input.email}</div>
              </div>
              ...
              <p style="margin: 18px 0 0; color: rgba(255,255,255,0.50); font-size: 12px; line-height: 1.6;">
          ...
          <tr>
            <td style="background-color: rgba(2,6,23,0.65); border-top: 1px solid rgba(148,163,184,0.18); padding: 18px 28px; text-align: center;">
              <p style="margin: 0 0 10px; color: rgba(255,255,255,0.60); font-size: 12px; line-height: 1.6;">
              ...
              <p style="margin: 0; color: rgba(255,255,255,0.42); font-size: 12px;">© ${new Date().getFullYear()} Metaclass</p>
            </td>
          </tr>
        </table>
      </td>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #020617;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(90deg, #020617 0%, #0f172a 55%, #0c1a2e 100%); padding: 28px 18px;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #0f172a; border-radius: 10px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.35); border: 1px solid rgba(148,163,184,0.18);">
          <tr>
          ...
          <tr>
            <td style="padding: 24px 24px 8px;">
              <h2 style="margin: 0 0 10px; color: #ffffff; font-size: 20px;">Novo inscrito</h2>
          ...
          <tr>
            <td style="padding: 0 24px 24px;">
              <div style="border: 1px solid rgba(148,163,184,0.22); border-radius: 10px; padding: 14px 14px; background: rgba(148,163,184,0.08);">
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="padding: 0 0 10px; color: rgba(255,255,255,0.60); font-size: 13px; width: 130px;">E-mail</td>
                    <td style="padding: 0 0 10px; color: #ffffff; font-size: 13px; font-weight: 800;">${input.email}</td>
                  </tr>
                  <tr>
                    <td style="padding: 0 0 10px; color: rgba(255,255,255,0.60); font-size: 13px;">Origem</td>
                    <td style="padding: 0 0 10px; color: #ffffff; font-size: 13px; font-weight: 700;">${input.source}</td>
                  </tr>
                  <tr>
                    <td style="padding: 0 0 10px; color: rgba(255,255,255,0.60); font-size: 13px;">Data</td>
                    <td style="padding: 0 0 10px; color: #ffffff; font-size: 13px; font-weight: 700;">${input.subscribedAtIso}</td>
                  </tr>
                  <tr>
                    <td style="padding: 0; color: rgba(255,255,255,0.60); font-size: 13px;">Message ID</td>
                    <td style="padding: 0; color: #ffffff; font-size: 13px; font-weight: 700;">${input.messageId ?? '-'}</td>
                  </tr>
                </table>
              </div>
            </td>

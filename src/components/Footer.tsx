  ...
  return (
    <div className="bg-white border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* linha cyan topo */}
        <div className="w-12 h-[3px] bg-brand-blue" />

        <div className="py-14 grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          {/* texto */}
          <div>
            <p className="text-xs font-bold text-brand-blue uppercase tracking-[0.18em] mb-4">
              Newsletter
            </p>
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="flex-1">
                    <input
                      ...
                      className={`w-full h-12 bg-white border-b-2 px-0 text-sm text-gray-900 placeholder-gray-400 outline-none transition-colors duration-200 ${
                        error ? 'border-red-400' : 'border-gray-200 focus:border-brand-blue'
                      }`}
                    />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="h-12 flex items-center gap-2 bg-gray-900 text-white px-6 text-sm font-semibold hover:bg-brand-blue hover:text-slate-950 transition-all duration-200 whitespace-nowrap"
                  >
                ...
                <p className="mt-4 text-xs text-gray-400">
                  Protegido pela{' '}
                  <Link to="/privacidade" className="underline underline-offset-2 hover:text-brand-blue transition-colors">
        ...
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="space-y-6 lg:col-span-4">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="rounded-full border border-brand-blue/30 bg-slate-900 px-2.5 py-1 text-xs text-gray-400">
                Enterprise
              </span>
              <span className="rounded-full border border-brand-blue/30 bg-slate-900 px-2.5 py-1 text-xs text-gray-400">
                Cloud Native
              ...
              <div className="flex gap-2">
                {[
                  ...
                  <a
                    ...
                    className="w-9 h-9 rounded-lg bg-slate-800/80 border border-slate-700/50 flex items-center justify-center text-gray-400 hover:text-brand-blue hover:border-brand-blue/40 hover:bg-slate-800 transition-all duration-200"
                  >
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:col-span-8 lg:grid-cols-3">
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li>
                  <Link to="/servicos" className="hover:text-brand-blue transition-colors">
                    Serviços
                  </Link>
                </li>
                <li>
                  <Link to="/cases" className="hover:text-brand-blue transition-colors">
                    Cases de sucesso
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                <li>
                  <Link to="/quem-somos" className="hover:text-brand-blue transition-colors">
                    Quem somos
                  </Link>
                </li>
                <li>
                  <Link to="/trabalhe-conosco" className="hover:text-brand-blue transition-colors">
                    Trabalhe conosco
                  </Link>
                </li>
                <li>
                  <Link to="/contato" className="hover:text-brand-blue transition-colors">
                    Contato
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                <li>
                  <Link to="/termos" className="hover:text-brand-blue transition-colors">
                    Termos de Uso
                  </Link>
                </li>
                <li>
                  <Link to="/privacidade" className="hover:text-brand-blue transition-colors">
                    Política de Privacidade
                  </Link>
                </li>
                <li>
                  <Link to="/lgpd" className="hover:text-brand-blue transition-colors">
                    Canal LGPD
                  </Link>
                </li>
                <li>

        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-3xl">
          <div className="space-y-8 text-gray-700">
            <p className="text-base leading-relaxed">
              A Metaclass está comprometida com a proteção da sua privacidade. Esta Política
              descreve como coletamos, usamos, armazenamos e protegemos suas informações quando
              você utiliza nossos produtos e serviços.
            </p>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1 text-base">
                ...
                <li>Dados de uso dos produtos (acessos, funcionalidades utilizadas)</li>
                <li>Dados inseridos por você nos sistemas (clientes, agendamentos, etc.)</li>
                <li>Informações técnicas (IP, tipo de navegador, dispositivo) para segurança e melhoria dos serviços</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-base leading-relaxed">
                Utilizamos os dados para: prestar e melhorar nossos produtos e serviços, processar
            ...
            <div>
              ...
              <p className="text-base leading-relaxed">
                ...
                quando aplicável, no legítimo interesse da Metaclass e no cumprimento de
            ...
            <div>
              ...
              <p className="text-base leading-relaxed">
                ...
                robustas para proteger seus dados contra acesso não autorizado, perda ou alteração
                indevida.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-base leading-relaxed">
                ...
                essencial dos produtos; (ii) registrar preferências; e, mediante consentimento
            ...
            <div>
              ...
              <p className="text-base leading-relaxed">
                ...
                e-mail ou aviso nos produtos. A continuação do uso após a divulgação constitui
